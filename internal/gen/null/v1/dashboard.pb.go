...
const file_null_v1_dashboard_proto_rawDesc = "" +
	...
	"\rNetWorthPoint\x12%\n" +
	"\x04date\x18\x01 \x01(\v2\x11.google.type.DateR\x04date\x12/\n" +
	"\tnet_worth\x18\x02 \x01(\v2\x12.google.type.MoneyR\bnetWorthB\x82\x01\n" +
	"\vcom.null.v1B\x0eDashboardProtoP\x01Z$null-mcp/internal/gen/null/v1;nullv1\xa2\x02\x03NXX\xaa\x02\aNull.V1\xca\x02\bNull_\\V1\xe2\x02\x14Null_\\V1\\GPBMetadata\xea\x02\bNull::V1b\x06proto3"
